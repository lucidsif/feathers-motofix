...
const createUserAppointment = (_, params, context) => context.appointment.createAppointment(params.token, params.motorcycle_address, params.estimated_start_time, params.estimated_end_time, params.status, params.fk_quote_id, params.fk_mechanic_id);
